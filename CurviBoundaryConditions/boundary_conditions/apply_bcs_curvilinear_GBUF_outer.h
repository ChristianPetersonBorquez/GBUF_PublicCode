...
#define BC_UPDATE_OUTER(which_gf, i0,i1,i2, FACEX0,FACEX1,FACEX2) {     \
    ...
    gfs[IDX4S(which_gf,i0,i1,i2)] =                                     \
        +4.0*gfs[IDX4S(which_gf,i0+1*FACEX0,i1+1*FACEX1,i2+1*FACEX2)]   \
        -6.0*gfs[IDX4S(which_gf,i0+2*FACEX0,i1+2*FACEX1,i2+2*FACEX2)]   \
        +4.0*gfs[IDX4S(which_gf,i0+3*FACEX0,i1+3*FACEX1,i2+3*FACEX2)]   \
        -1.0*gfs[IDX4S(which_gf,i0+4*FACEX0,i1+4*FACEX1,i2+4*FACEX2)];  \
    }
