...
#pragma omp parallel for
    ...
    //IN THE FOLLOWING INDEX 3 STANDS FOR GPLUS (GP) GRIDFUNCTION, 5 FOR GMINUS (PSI[0])
    ...
    //for(int i1d=0; i1d<Nxx_plus_2NGHOSTS1; i1d++){
        //for(int i2d=0; i2d<Nxx_plus_2NGHOSTS2; i2d++){
            ...
            //gfs[IDX4S(3,i0d,i1d,i2d)] = gfs[IDX4S(5,i0s,i1d,i2d)];
            //gfs[IDX4S(5,i0d,i1d,i2d)] = gfs[IDX4S(3,i0s,i1d,i2d)];
        //} // END for i1d
    //} // END for i2d
    ...
    gfs[IDX4S(3,i0d,i1d,i2d)] = gfs[IDX4S(5,i0s,i1s,i2s)];
    gfs[IDX4S(5,i0d,i1d,i2d)] = gfs[IDX4S(3,i0s,i1s,i2s)];
