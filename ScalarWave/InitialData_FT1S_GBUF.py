...
def SphericalGaussian(CoordSystem="Cartesian",default_time=0,default_sigma=1/4,default_center=1/4):
    ...
    global gg_ID, gp_ID, chi_ID, chip_ID, chipp_ID, psig_ID, psib_ID, Radius_ID, sinth_ID, costh_ID, Rprime_ID, rcoord_ID, bb_ID, bp_ID, uu_ID, up_ID, psiu_ID, fgauge_ID, fgaugep_ID, psif_ID
    ...
    #gg_ID = 1*sp.exp(-Radius_ID**2)*chi_ID # SPHERICALLY SYMMETRIC, SAME AS FORTRAN CODE
    ...
    #gg_ID = -chi_ID*sp.exp( -(1 + 4*Radius_ID)**2/16 )*(-12 -6*Radius_ID -17*Radius_ID**2 -8*Radius_ID**3 -16*Radius_ID**4 + sp.exp(Radius_ID)*(12 -6*Radius_ID +17*Radius_ID**2 -8*Radius_ID**3 +16*Radius_ID**4))/(4*Radius_ID**3)*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID*costh_ID*(cosphi**2-sinphi**2)) #NO SYMMETRY, R-1/4 #ARE WE SURE THIS COINCIDES WITH ONE OF THE SPHERICAL HARMONICS?????
    ...
    gg_ID = chi_ID*sp.exp( -(1 + 4*Radius_ID)**2/16 )*(-4 -2*Radius_ID -15*Radius_ID**2 +8*Radius_ID**3 +16*Radius_ID**4 + sp.exp(Radius_ID)*(4 -2*Radius_ID +15*Radius_ID**2 +8*Radius_ID**3 -16*Radius_ID**4))/(4*Radius_ID)*(1/4)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID**2*(cosphi**2-sinphi**2))   #NO SYMMETRY, R²(R-1/4)
    ...
    psig_ID = ixp.zerorank1()
    psib_ID = ixp.zerorank1()
    psiu_ID = ixp.zerorank1()
    psif_ID = ixp.zerorank1()
    ...
    #gp_ID = 1*sp.exp(-Radius_ID**2)*chi_ID*( chip_ID - sp.sympify(2)*Radius_ID*chi_ID ) #SPHERICALLY SYMMETRIC, SAME AS FORTRAN CODE
    ...
    gp_ID = chi_ID**2*(1/(8*Radius_ID**2))*sp.exp(-(1 + 4*Radius_ID)**2/16)*(8 +4*Radius_ID -12*Radius_ID**2 +55*Radius_ID**3 +148*Radius_ID**4 -48*Radius_ID**5 -64*Radius_ID**6 + sp.exp(Radius_ID)*(-8 +4*Radius_ID +12*Radius_ID**2 +55*Radius_ID**3 -148*Radius_ID**4 -48*Radius_ID**5 +64*Radius_ID**6))*(1/4)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID**2*(cosphi**2-sinphi**2)) +chip_ID*gg_ID #NO SYMMETRY, R²(R-1/4)
    ...
    #psig_ID[0] = (sp.sympify(4)/sigma**4)*sp.exp( -((center**2-Radius_ID**2)**2/sigma**4) )*Radius_ID*(-center+Radius_ID)*(center+ Radius_ID)*chi_ID # SPHERICALLY SYMMETRIC
    #psig_ID[0] = sp.sympify(2)*sp.exp(-Radius_ID**2)*Radius_ID*chi_ID # SPHERICALLY SYMMETRIC, SAME AS FORTRAN CODE
    #psig_ID[0] = -chi_ID*(1/(8*Radius_ID**4))*sp.exp(-(1 + 4*Radius_ID)**2/16)*(-72 -36*Radius_ID -88*Radius_ID**2 -41*Radius_ID**3 -44*Radius_ID**4 -48*Radius_ID**5 -64*Radius_ID**6 + sp.exp(Radius_ID)*(72 -36*Radius_ID +88*Radius_ID**2 -41*Radius_ID**3 +44*Radius_ID**4 -48*Radius_ID**5 +64*Radius_ID**6))*(1/4)*(sp.sqrt(5/sp.pi))*(3*costh_ID**2-1) #AXISYMMETRIC R-1/4
    #psig_ID[0] = chi_ID*(1/(Radius_ID**4))*sp.exp(-(1 + Radius_ID)**2)*(-9 -18*Radius_ID -26*Radius_ID**2 -28*Radius_ID**3 -28*Radius_ID**4 -24*Radius_ID**5 -8*Radius_ID**6 + sp.exp(4*Radius_ID)*(9 -18*Radius_ID + 26*Radius_ID**2 -28*Radius_ID**3 +28*Radius_ID**4 -24*Radius_ID**5 +8*Radius_ID**6))*(1/4)*(sp.sqrt(5/sp.pi))*(3*costh_ID**2-1)  #AXIALLY SYMMETRIC

    #psig_ID[0] = -chi_ID*(1/(8*Radius_ID**4))*sp.exp(-(1 + 4*Radius_ID)**2/16)*(-72 -36*Radius_ID -88*Radius_ID**2 -41*Radius_ID**3 -44*Radius_ID**4 -48*Radius_ID**5 -64*Radius_ID**6 + sp.exp(Radius_ID)*(72 -36*Radius_ID +88*Radius_ID**2 -41*Radius_ID**3 +44*Radius_ID**4 -48*Radius_ID**5 +64*Radius_ID**6))*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID*costh_ID*(cosphi**2-sinphi**2)) #NO SYMMETRY, R-1/4

    #psig_ID[0] = -chi_ID*(sp.exp(-(1/16)*(1 +4*Radius_ID)**2)*(-375*(6 +Radius_ID +4*Radius_ID**2) -2*sp.exp(7/400*(3 +40*Radius_ID))*Radius_ID*(-150 +520*Radius_ID -251*Radius_ID**2 +530*Radius_ID**3 -300*Radius_ID**4 +1000*Radius_ID**5) +2*sp.exp(3/400*(7 +40*Radius_ID))*(1125 +225*Radius_ID +1270*Radius_ID**2 +251*Radius_ID**3 +530*Radius_ID**4 +300*Radius_ID**5 +1000*Radius_ID**6)))/(250*Radius_ID**4)*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID*costh_ID*(cosphi**2-sinphi**2)) #NO SYMMETRY, R+1/10

    psig_ID[0] = -chi_ID*(1/(8*Radius_ID**2))*sp.exp(-(1 + 4*Radius_ID)**2/16)*(8 +4*Radius_ID -12*Radius_ID**2 +55*Radius_ID**3 +148*Radius_ID**4 -48*Radius_ID**5 -64*Radius_ID**6 + sp.exp(Radius_ID)*(-8 +4*Radius_ID +12*Radius_ID**2 +55*Radius_ID**3 -148*Radius_ID**4 -48*Radius_ID**5 +64*Radius_ID**6))*(1/4)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID**2*(cosphi**2-sinphi**2))  #NO SYMMETRY, R²(R-1/4)

    #psig_ID[0] = (r*(center**2*r**2 - r**4 + 2*sigma**4)*cosphi)/(sp.exp((center**2 - r**2)**2/(4.*sigma**4))*sigma**4) #CRAPPY ATTEMPT
    #psig_ID[0] = r*sp.exp(-(r*r-center*center)**2/(4*sigma**4))*( 2-r*r*(r*r-center*center)/sigma**4 )*cosphi #CRAPPY ATTEMPT
    #psig_ID[0] = chi_ID*(-2)*Radius_ID*sp.exp( -(Radius_ID*Radius_ID-center*center*(1+4*1/sp.sqrt(1+tanphi**2)))**2/sigma**4 )*( 1-2*Radius_ID*Radius_ID*(Radius_ID*Radius_ID-center*center*(1+4*1/sp.sqrt(1+tanphi**2)))/sigma**4 ) #not spherically symmetric
    #psig_ID[0] = sp.sympify(0)

    #psig_ID[1] = (center**2* sp.exp(-((-center**2* (1 - costheta**2/2) *(1 - sinphi**2/2) +Radius_ID**2)**2/(4 *sigma**4)))*costheta* (1 - sinphi**2/2) *(-center**2 *(1 - costheta**2/2) *(1 - sinphi**2/2) + Radius_ID**2) *sintheta)/(2*sigma**4)  # NONSPHERICAL BUT NONSMOOTH AT THE ORIGIN


    #psig_ID[1] = sp.sympify(0)
    #psig_ID[1] = chi_ID*(1/(8*Radius_ID**3))*3*sp.exp( -(1 + 4*Radius_ID)**2/16 )*sp.sqrt(5/sp.pi)*(-12 -6*Radius_ID -17*Radius_ID**2 -8*Radius_ID**3 -16*Radius_ID**4 + sp.exp(Radius_ID)*(12 -6*Radius_ID +17*Radius_ID**2 -8*Radius_ID**3 + 16*Radius_ID**4))*costh_ID*sinth_ID #AXISYMMETRIC, R-1/4

    #psig_ID[1] = -(3/(2*Radius_ID**3))*sp.exp(-(1 + Radius_ID)**2)*sp.sqrt(5/sp.pi)*(-3 -6*Radius_ID -8*Radius_ID**2 -8*Radius_ID**3 -4*Radius_ID**4 +sp.exp(4*Radius_ID)*(3 -6*Radius_ID +8*Radius_ID**2 -8*Radius_ID**3 +4*Radius_ID**4))*costh_ID*sinth_ID * chi_ID    #AXISYMMETRIC

    #psig_ID[1] = -chi_ID*sp.exp( -(1 + 4*Radius_ID)**2/16 )*(-12 -6*Radius_ID -17*Radius_ID**2 -8*Radius_ID**3 -16*Radius_ID**4 + sp.exp(Radius_ID)*(12 -6*Radius_ID +17*Radius_ID**2 -8*Radius_ID**3 +16*Radius_ID**4))/(4*Radius_ID**3)*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*((costh_ID**2-sinth_ID**2)*(cosphi**2-sinphi**2)) #NO SYMMETRY, R-1/4

    #psig_ID[1] = -chi_ID*(sp.exp(-(1/16)*(1 +4*Radius_ID)**2)*(-375*(6 +Radius_ID +4*Radius_ID**2) -2*sp.exp(7/400*(3 +40*Radius_ID))*Radius_ID*(-150 +520*Radius_ID -251*Radius_ID**2 +530*Radius_ID**3 -300*Radius_ID**4 +1000*Radius_ID**5) +2*sp.exp(3/400*(7 +40*Radius_ID))*(1125 +225*Radius_ID +1270*Radius_ID**2 +251*Radius_ID**3 +530*Radius_ID**4 +300*Radius_ID**5 +1000*Radius_ID**6)))/(250*Radius_ID**4)*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*((costh_ID**2-sinth_ID**2)*(cosphi**2-sinphi**2)) #NO SYMMETRY, R+1/10

    psig_ID[1] = chi_ID*sp.exp( -(1 + 4*Radius_ID)**2/16 )*(-4 -2*Radius_ID -15*Radius_ID**2 +8*Radius_ID**3 +16*Radius_ID**4 + sp.exp(Radius_ID)*(4 -2*Radius_ID +15*Radius_ID**2 +8*Radius_ID**3 -16*Radius_ID**4))/(4*Radius_ID)*(1/4)*(sp.sqrt(15/(2*sp.pi)))*(2*sinth_ID*costh_ID*(cosphi**2-sinphi**2))   #NO SYMMETRY, R²(R-1/4)


    #psig_ID[2] = sp.sympify(0)
    #psig_ID[2] = -chi_ID*sp.exp( -(1 + 4*Radius_ID)**2/16 )*(-12 -6*Radius_ID -17*Radius_ID**2 -8*Radius_ID**3 -16*Radius_ID**4 + sp.exp(Radius_ID)*(12 -6*Radius_ID +17*Radius_ID**2 -8*Radius_ID**3 +16*Radius_ID**4))/(4*Radius_ID**3)*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*(costh_ID*(-4*cosphi*sinphi)) #NO SYMMETRY, R-1/4

    #psig_ID[2] = -chi_ID*(sp.exp(-(1/16)*(1 +4*Radius_ID)**2)*(-375*(6 +Radius_ID +4*Radius_ID**2) -2*sp.exp(7/400*(3 +40*Radius_ID))*Radius_ID*(-150 +520*Radius_ID -251*Radius_ID**2 +530*Radius_ID**3 -300*Radius_ID**4 +1000*Radius_ID**5) +2*sp.exp(3/400*(7 +40*Radius_ID))*(1125 +225*Radius_ID +1270*Radius_ID**2 +251*Radius_ID**3 +530*Radius_ID**4 +300*Radius_ID**5 +1000*Radius_ID**6)))/(250*Radius_ID**4)*(-1/2)*(sp.sqrt(15/(2*sp.pi)))*(costh_ID*(-4*cosphi*sinphi)) #NO SYMMETRY, R+1/10

    psig_ID[2] = chi_ID*sp.exp( -(1 + 4*Radius_ID)**2/16 )*(-4 -2*Radius_ID -15*Radius_ID**2 +8*Radius_ID**3 +16*Radius_ID**4 + sp.exp(Radius_ID)*(4 -2*Radius_ID +15*Radius_ID**2 +8*Radius_ID**3 -16*Radius_ID**4))/(4*Radius_ID)*(1/4)*(sp.sqrt(15/(2*sp.pi)))*(sinth_ID*(-4*sinphi*cosphi))   #NO SYMMETRY, R²(R-1/4)
