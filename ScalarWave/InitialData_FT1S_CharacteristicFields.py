...
def SphericalGaussian(CoordSystem="Cartesian",default_time=0,default_sigma=3,default_center=1/4):
    ...
    global gg_ID, gp_ID, alpha_ID, chi_ID, omega_ID, betaU, psi_ID
    ...
    gg_ID = 1*r*r*sp.exp(-(r*r-center*center)**2/(4*sigma**4)) # spherically symmetric omega_ID*omega_ID*
    ...
    gp_ID = r*sp.exp(-(r*r-center*center)**2/(4*sigma**4))*( 2-r*r*(r*r-center*center)/sigma**4 ) #spherically symmetric
    ...
    psi_ID[0] = -r*sp.exp(-(r*r-center*center)**2/(4*sigma**4))*( 2-r*r*(r*r-center*center)/sigma**4 ) #spherically symmetric
